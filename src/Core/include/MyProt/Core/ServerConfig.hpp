...
// v1.1 增: 全局服务端配置 (仿真 + 未来告警/webhook 等)
//
// 背景: 协议层 (ProtocolConfig.simulation) 不应承载 listenPort / initialValues / packetLossRate
// 等服务端行为字段 — 这些是部署环境属性, 与协议语法无关. v1.1 起 simulation 段移至
...
//   (原文"与 protocols 不共享版本号, 独立代际"的说法与实装不符, v1.30 修正)
#pragma once
...
// 全局服务端配置. v1 阶段仅含 simulation, v1.5+ 可扩展 alertSink / webhook / oem.
struct ServerConfig {
