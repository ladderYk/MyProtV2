...
> Design docs (architecture, modules, ADRs) live in [docs/README.md](docs/README.md) — currently written in Chinese.
...
# See docs/architecture/06_Extension_and_Simulation.md (Chinese)
```
...
Single source of truth for the config schema: [docs/Config_Schema.md](docs/Config_Schema.md) (Chinese).
...
> Threading and data-flow details: [docs/architecture/03_Threading_and_DataFlow.md](docs/architecture/03_Threading_and_DataFlow.md); config grammar: [docs/Config_Schema.md](docs/Config_Schema.md) (both in Chinese).
...
| SEER | TCP | LengthField | `configs/protocols/seer-robot.json` |
...
| SEER (AGV, JSON payload) | TCP | LengthField (4B) + JSON data | `configs/protocols/seer.json` (tutorial: [docs/protocols/seer.md](docs/protocols/seer.md), Chinese) |
